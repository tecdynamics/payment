    ...
    <div class="container">
        <div class="row">
            <div class="group flexbox-annotated-section">
                ...
                <div class="col-md-9">
                    @php do_action(BASE_ACTION_META_BOXES, 'top', new \Tec\Payment\Models\Payment) @endphp
                    ...
                    <div class="wrapper-content pd-all-20">
                        ...
                        <div class="form-group mb-3">
                            ...
                            {!! Form::customSelect('default_payment_method', \Tec\Payment\Enums\PaymentMethodEnum::labels(), setting('default_payment_method', Tec\Payment\Enums\PaymentMethodEnum::STRIPE)) !!}
                        </div>
                    ...
                    <table class="table payment-method-item">
                        ...
                        <tr class="paypal-online-payment payment-content-item hidden">
                            <td class="border-left" colspan="3">
                                {!! Form::open() !!}
                                {!! Form::hidden('type', \Tec\Payment\Enums\PaymentMethodEnum::STRIPE, ['class' => 'payment_type']) !!}
                                <div class="row">
                                    <div class="col-sm-6">
                                        <ul>
                                            <li>
                    ...
                    <table class="table payment-method-item">
                        ...
                        <tr class="paypal-online-payment payment-content-item hidden">
                            <td class="border-left" colspan="3">
                                {!! Form::open() !!}
                                {!! Form::hidden('type', \Tec\Payment\Enums\PaymentMethodEnum::PAYPAL, ['class' => 'payment_type']) !!}
                                <div class="row">
                                    <div class="col-sm-6">
                                        <ul>
                                            <li>
                     ...
                     <table class="table payment-method-item">
                                ...
                                <td colspan="3">
                                    <div class="float-start" style="margin-top: 5px;">
                                        <div class="payment-name-label-group">
                                            @if ($codStatus != 0)<span class="payment-note v-a-t">{{ trans('plugins/payment::payment.use') }}:</span>@endif <label class="ws-nm inline-display method-name-label">{{ setting('payment_cod_name', \Tec\Payment\Enums\PaymentMethodEnum::COD()->label()) }}</label>
                                        </div>
                                    </div>
                                    <div class="float-end">
                                    ...
                                    <div class="col-sm-12 mt-2">
                                        <div class="well bg-white">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="next-input" name="payment_cod_name" id="payment_cod_name" data-counter="400" value="{{ setting('payment_cod_name', \Tec\Payment\Enums\PaymentMethodEnum::COD()->label()) }}">
                                            </div>
                                            <div class="form-group mb-3">
                            ...
                            <tr class="bg-white">
                                <td colspan="3">
                                    <div class="float-start" style="margin-top: 5px;">
                                        <div class="payment-name-label-group">
                                            @if ($bankTransferStatus != 0) <span class="payment-note v-a-t">{{ trans('plugins/payment::payment.use') }}:</span>@endif <label class="ws-nm inline-display method-name-label">{{ setting('payment_bank_transfer_name', \Tec\Payment\Enums\PaymentMethodEnum::BANK_TRANSFER()->label()) }}</label>
                                        </div>
                                    </div>
                                    <div class="float-end">
                                    ...
                                    <div class="col-sm-12 mt-2">
                                        <div class="well bg-white">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="next-input" name="payment_bank_transfer_name" id="payment_bank_transfer_name" data-counter="400" value="{{ setting('payment_bank_transfer_name', \Tec\Payment\Enums\PaymentMethodEnum::BANK_TRANSFER()->label()) }}">
                                            </div>
                                            <div class="form-group mb-3">
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'main', new \Tec\Payment\Models\Payment) @endphp
            <div class="group">
                <div class="col-md-3">

                </div>
                <div class="col-md-9">
                    @php do_action(BASE_ACTION_META_BOXES, 'advanced', new \Tec\Payment\Models\Payment) @endphp
                </div>
            </div>
        </div>
    </div>
