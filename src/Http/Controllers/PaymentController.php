...
namespace Tec\Payment\Http\Controllers;
...
use Tec\Payment\Http\Requests\CheckoutRequest;
use Tec\Payment\Http\Requests\PaymentMethodRequest;
use Tec\Payment\Http\Requests\PayPalPaymentCallbackRequest;
use Tec\Payment\Http\Requests\UpdatePaymentRequest;
use Tec\Payment\Repositories\Interfaces\PaymentInterface;
use Tec\Payment\Services\Gateways\BankTransferPaymentService;
use Tec\Payment\Services\Gateways\CodPaymentService;
use Tec\Payment\Services\Gateways\PayPalPaymentService;
use Tec\Payment\Services\Gateways\StripePaymentService;
use Tec\Payment\Tables\PaymentTable;
