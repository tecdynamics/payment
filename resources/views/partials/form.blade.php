                ...
                @if (setting('payment_cod_status') == 1)
                    <li class="list-group-item">
                        <input class="magic-radio js_payment_method" type="radio" name="payment_method" id="payment_cod"
                               @if (setting('default_payment_method') == \Tec\Payment\Enums\PaymentMethodEnum::COD) checked @endif
                        ...
                        <div class="payment_cod_wrap payment_collapse_wrap collapse @if (setting('default_payment_method') == \Tec\Payment\Enums\PaymentMethodEnum::COD) show @endif" style="padding: 15px 0;">
                ...
                @if (setting('payment_bank_transfer_status') == 1)
                    <li class="list-group-item">
                        <input class="magic-radio js_payment_method" type="radio" name="payment_method" id="payment_bank_transfer"
                               @if (setting('default_payment_method') == \Tec\Payment\Enums\PaymentMethodEnum::BANK_TRANSFER) checked @endif
                        ...
                        <div class="payment_bank_transfer_wrap payment_collapse_wrap collapse @if (setting('default_payment_method') == \Tec\Payment\Enums\PaymentMethodEnum::BANK_TRANSFER) show @endif" style="padding: 15px 0;">
